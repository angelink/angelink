...
var qb = new QueryBuilder('Follower', schema);

// ## Model
var Follower = function (_data) {
  _.extend(this, _data);
...
Follower.prototype.modelName = 'Follower';

// ## Results Functions
var _singleFollower = _.partial(utils.formatSingleResponse, Follower);
...
var create = function (params, options) {
  var func = new Construct(_create, _singleFollower);
...
Follower.prototype.onDay = _.partial(_hasRelationship, {label:'ON_DAY'});

Follower.create = create;
