...
_fn = function(directiveName) {
  return angular.module("n4j.pages.directives").directive(directiveName, [
...
angular.module("n4j.pages.directives").directive("taggerContenteditable", function() {
  return {
    require: "ngModel",
...
angular.module("n4j.pages.directives").directive("tagger", [
